...
\begin{itemize}
  \item Conduct Probability of Default/Loss Given Default(PD/LGD)) models implementation tests to ensure model runs in timely fashion and generate accurate output
  \item Run the credit rating PD and LGD model implementation tests to ensure the new developed model successfully rolled out on the risk rating system, including Business Requirement Test, Random Sample Test, and Expect Results Test
