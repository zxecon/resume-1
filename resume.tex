...
%With Daniela Rivero Bryant, Lu Yao
\begin{itemize}
  \item Target: This project aims to predict the probility of deault (PD) based on historical data on 250,000 borrowers with features including income, debt ratio, number of dependents, real estate loan status etc.
  \item Methods: PD analysis gives the liklihood of a default given certain time period; Use python to clean data, build baseline logit model, stepwise feature slection and cross-validate models
  %\item Test the hypothsis with using Ordinary Least Square (OLS), Logit model and Hazard model (survical analysis);
  %\item Outcomes: We find that people who reported better health tend to accumulate more years of education
  \end{itemize}
