...
\begin{itemize}[parsep=0.25ex]
  ...
  \item \textbf{Experience with}:
   Causal Inference; A/B testing; Machine Learning; Health Datasets(IPUMS, NLSY, CDC database); Data Visualization with Tableau (Basic); Python Packages (Numpy, Pandas, Matplotlib, SciPy, scikit-learn, statsmodels, DoWhy), research on investment/asset pricing
