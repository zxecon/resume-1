...
\begin{itemize}[parsep=0.25ex]
  ...
  \item \textbf{Experience with}:
   Causal Inference; A/B testing; Machine Learning; Finacial Datasets(CRSP, CapIQ, Bloomberg Terminal); Data Visualization with Tableau (Basic); Python Packages (Numpy, Pandas, Matplotlib, SciPy, scikit-learn, statsmodels, DoWhy)
