...
\begin{itemize}
  \item Conduct the Probability of Default/Loss Given Default(PD/LGD)) models implementation tests to ensure model runs in a timely fashion and generate accurate output
  \item Run the credit rating PD and LGD model implementation tests to ensure the newly developed model successfully rolled out on the risk rating system, including Business Requirement Test, Random Sample Test, and Expect Results Test
  \item Monitor models across over ten different industries, validate SAS codes, and provide statistical reports for future model development and validation
\end{itemize}
