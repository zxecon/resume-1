...
\begin{itemize}
  \item Conduct Probability of Default/Loss Given Default models implementation tests to ensure model runs in timely fashion and generate accurate output
  ...
  \item Monitor models across over ten different industries 
\end{itemize}
