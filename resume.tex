...
\basicInfo{
  \email{zxietulane@outlook.com} \textperiodcentered\
...
%With Daniela Rivero Bryant, Lu Yao
\begin{itemize}
  \item Target: Forecast the probability of default (PD) based on historical data on 250,000 borrowers(from Kaggle) with features including income, debt ratio, number of dependents, real estate loan status, etc. 
...
Adjunct Assistant Professor(Starting 08/2020), Research/Teaching Assistant
\begin{itemize}
...
%\datedsubsection{\textbf{Study.com, llc}}{08/2020 -- Present}
%Consultant/Economics Expert
%\begin{itemize}
  %\item Provide solutions to college-level intro to advanced economics questions;
%\end{itemize}
