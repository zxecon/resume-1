...
\begin{itemize}
  ...
  \item Monitor models across over ten different industries(corporate banking, commercial real estate, tech\&life science, etc.), create/validate PD model backtesting SAS codes, and provide statistical reports for future model development and validation
\end{itemize}
