...
\basicInfo{
  \email{hsieh2019001@gmail.com} \textperiodcentered\
...
\datedsubsection{\textbf{Comerica Bank}}{09/2015 -- Now}
Model Implementation Officer(Portfolio Risk Analytics)
\begin{itemize}
  \item Conducted Probability of Default/Loss Given Default models implementation tests to ensure model runs in timely fashion and generate accurate output
  \item Run the Credit Rating PD and LGD Model implementation tests to ensure the new developed model successfully rolled out on the DCORR-Risk Rating System, including Business Requirement Test, Random Sample Test, and Expect Results Test
\end{itemize}
...
\begin{itemize}[parsep=0.25ex]
  \item \textbf{Coding}:
    STATA, R, SAS(\href{https://www.youracclaim.com/badges/c4bce10e-7398-4203-9d11-f9c6723749a4/linked_in_profile}{SAS Certified Advanced Programmer}), SQL, Python, Excel, Visual Basic, EViews, Markdown, $L^{A}T_{E}X$
