...
\begin{itemize}[parsep=0.25ex]
  ...
  \item \textbf{Experience with}:
   Causal Inference; A/B test; Machine Learning; Computing with Cypress (Tulane University High Performance Computing system, with coding in UNIX OS); Data Visualization with Tableau (Basic); Python Packages (Numpy, Pandas, Matplotlib, SciPy, scikit-learn, statsmodels, DoWhy)
