...
%With Daniela Rivero Bryant, Lu Yao
\begin{itemize}
  \item Target: Predict the probability of default (PD) based on historical data on 250,000 borrowers(from Kaggle) with features including income, debt ratio, number of dependents, real estate loan status, etc. 
