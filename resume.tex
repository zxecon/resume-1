...
\datedsubsection{\textbf{Tulane University}, New Orleans, LA}{07/2015 -- 05/2020 (expected)}
  ...
  Research Interest: Causal Inference, Applied Microeconometrics, Applied Econometrics
...
\begin{itemize}
  ...
  \item Utilize an event study model based on previous literature to prove firms' behaviors after each pociy change were tax-driven; Use a difference-in-differences model to examine the impact of the 2005 and 2012 policy changes on stocks’ turnover rates and trading volumes;
