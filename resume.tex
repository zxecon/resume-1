...
\datedsubsection{\textbf{Tulane University}, New Orleans, LA}{07/2015 -- 05/2020}
  Ph.D. Economics(STEM)
  Research Interests: Applied Microeconomics, Applied Econometrics, Causal Inference
...
\begin{itemize}[parsep=0.25ex]
  ...
  \item \textbf{Experience with}:
   Causal Inference; A/B testing; Time-series(ARIMA/GARCH); Machine Learning; Finacial Datasets(CRSP, CapIQ, Bloomberg Terminal); Health Datasets(IPUMS, NLSY, CDC database); Data Visualization with Tableau (Basic); Research on investment/asset pricing; Knowledge of corporate governance/credit risk
